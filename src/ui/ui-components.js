    ...
    return `
      <div class="color-group-card-plugin bg-[var(--bg-card)] border border-[var(--border)] rounded-[16px] p-4 space-y-4 shadow-sm hover:shadow-md transition-all group relative overflow-hidden">
        <div class="grid grid-cols-[20px_1fr_1fr_40px] gap-2">
          ...
          <button onclick="removeGroup(${idx})" class="bg-[var(--danger)]/10 text-[var(--danger)] border border-[var(--danger)]/20 self-end size-[40px] flex items-center justify-center rounded-[8px] transition-all hover:bg-[var(--danger)]/20">${Icons.Trash}</button>
        </div>
